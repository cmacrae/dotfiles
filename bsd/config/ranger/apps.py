...
class CustomApplications(Applications):
	...
	def app_mplayer(self, c):
		if c.mode is 1:
			return 'mplayer', '-fs -vo vaapi -monitoraspect 16:10', c

		elif c.mode is 2:
			args = "mplayer -fs -vo vaapi -monitoraspect 16:10 -sid 0 -vfm ffmpeg -lavdopts " \
